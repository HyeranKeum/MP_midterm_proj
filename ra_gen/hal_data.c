...
const timer_cfg_t Error_timer_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 1 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x8000,
  .duty_cycle_counts = 0x4000, .source_div = (timer_source_div_t) 0, .channel = 0, .p_callback = R_AGT0_Interrupt,
...
const timer_instance_t Error_timer =
{ .p_ctrl = &Error_timer_ctrl, .p_cfg = &Error_timer_cfg, .p_api = &g_timer_on_agt };
...
{ .scan_mask = ADC_MASK_CHANNEL_0 | ADC_MASK_CHANNEL_2 | 0, .scan_mask_group_b = 0, .priority_group_a =
