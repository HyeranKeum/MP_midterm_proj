...
//     L293_CH0_Direction_Level = BSP_IO_LEVEL_HIGH; // 시계방향(high면 왼쪽
//     R_IOPORT_PinWrite(&g_ioport_ctrl, L293_CH0_Direction, L293_CH0_Direction_Level);
...
uint8_t LED_PA08_Enable_Level = BSP_IO_LEVEL_HIGH;
...
void R_IRQ_Interrupt(external_irq_callback_args_t *p_args)
{
    switch(p_args->channel)
    {
        case 11:
            ...
            LED_PA08_Enable_Level ^= 0x01;
            R_IOPORT_PinWrite(&g_ioport_ctrl, L293_CH0_Enable, L293_CH0_Enable_Level);
            R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_10_PIN_08, LED_PA08_Enable_Level);
            break;
        case 12:
